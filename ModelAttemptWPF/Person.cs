...
public class Person
{
    ...
    public void DetermineComplexBehaviours()
    {
        ...
        this.sharingFreq = ((this.ext + this.nrt) / 2 * usePsych + simulation.NormalDistribution(0.5,0.18) * (1-usePsych)) * SHARING_FREQ_FACTOR; // av 0.125, between 0 and 0.25 (with SFF of 0.25) -> so 0.5, and between 0 and 1
    }
